    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="container">
                <div class="max-w-7xl mx-auto p-6 lg:p-8">
                    <div class="flex justify-center">
                        <img src="/images/iconG.png"  class="h-16 w-auto">
                    </div>
    
                    <div class="flex mt-10 justify-center">
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Galeri Foto</h2>
                    </div>
            ...
            <div class="row">
                ...
                @guest
                    @if ($fotos->hasLikee)
                    <a class="text-danger text-decoration-none" href="/likee/{{ $foto[0]->id }}">
                        <i class="bi bi-heart-fill me-1"></i>({{ $fotos->totalLikes() }})
                    </a>
                    @else
                        <a class="text-dark text-decoration-none" href="/likee/{{ $foto[0]->id }}">
                            <i class="bi bi-heart-fill me-1"></i>({{ $fotos->totalLikes() }})
                        </a>
                    @endif
                @endguest
